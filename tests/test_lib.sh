...
ARRAY_APP=("default" "ceph" "hadoop_hdd" "hadoop_ssd" "mongodb" "mariadb" "mysql" "postgresql" "nginx" "nginx_http" "apache" "redis" "speccpu" "specjbb" "dubbo" "robox" "kvm" "hpc" "olc" "mariadb_kvm" "mariadb_docker")
